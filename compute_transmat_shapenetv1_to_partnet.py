...
shapenet_dir = '/home/donglin/Data/ShapeNetCore.v1/'
partnet_dir = os.path.join('/home/donglin/Data/data_v0', anno_id)
...
# test
cur_shapenet_dir = os.path.join(shapenet_dir, cat_id, model_id)
...
with open(os.path.join(out_dir, anno_id+'.txt'), 'w') as fout:
    fout.write('%f\n' % chamfer_dist)
